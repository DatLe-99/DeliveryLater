        ...
        return (
            <ImageBackground source={LoginBackground} style={{ width: WINDOW_SIZE.WIDTH, height: WINDOW_SIZE.HEIGHT }}>
                <View style={{ alignContents: 'center', flexDirection: 'column', alignItems: 'center', marginTop: 50 }}>
                    ...
                    <NotHaveAccount onPressRegister={() => this.props.navigation.navigate("Register")}></NotHaveAccount>
...
class LoginButton extends Component {
    render() {
        return (
            <TouchableOpacity onPress={this.props.onPress} style={{ width: 208, heigth: 42, backgroundColor: '#D54646', borderRadius: 21 }}>
...
class NotHaveAccount extends Component {
    render() {
        return (
            <TouchableOpacity onPress={this.props.onPressRegister} style={{ width: 367, heigth: 42, backgroundColor: '#0B76C5', borderRadius: 13 }}>
